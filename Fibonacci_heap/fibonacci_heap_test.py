...
class TestFibonacciHeap(unittest.TestCase):
    ...
    def test_insert_single(self):
        ...
        self.assertEqual(self.heap.minFibNode, node, "Inserted node should be the min node")
        self.assertEqual(self.heap.rootList, node, "Inserted node should be the rootList entry point")
    
    def test_insert_multiple(self):
        nodes = [self.heap.insert(i)[0] for i in range(10, 0, -1)]
        self.assertEqual(self.heap.minFibNode.value, 1, "The new minimum node should have the value 1")
        self.assertEqual(self.heap.totalFibNodes, 10, "Checks the total nodes")

    def test_insert_in_heaps_double_circular_linked_list_property_maintained(self):
        heap1 = FibonacciHeap()
        heap1.insert(10)
        self.assertEqual(heap1.rootList.value, 10, "The first node in the root list should be 10")
        heap1.insert(11)
        self.assertEqual(heap1.rootList.value, 10, "The first node in the root list should be 10")
        self.assertEqual(heap1.rootList.right.value, 11, "The next node in the root list should be 11")
        self.assertEqual(heap1.rootList.right.right.value, 10, "The next node in the root list should be 10 as it circles back")
        heap1.insert(12)
        self.assertEqual(heap1.rootList.value, 10, "The first item in the root list should be 10")
        self.assertEqual(heap1.rootList.right.value, 11, "The first item in the root list should be 10")
        self.assertEqual(heap1.rootList.right.right.value, 12, "The first item in the root list should be 10")
        self.assertEqual(heap1.rootList.right.right.right.value, 10, "The next node in the root list should be 10 as it circles back")
    ...
    def test_update_min_with_single_node_lower_value(self):
        ...
        self.assertEqual(self.heap.minFibNode.value, 5, "The new min node should be 5")
    ...
    def test_update_min_with_single_node_higher_value(self):
        ...
        self.assertEqual(self.heap.minFibNode.value, 10, "Unchanged min node")
    ...
    def test_update_min_with_single_node_same_value(self):
        ...
        self.assertEqual(self.heap.minFibNode.value, 10, "new min node, same value")
    ...
    def test_set_new_min_from_root_list_multiple_nodes_in_root(self):
        ...
        self.heap.insert(9)
        self.heap.minFibNode = None
        self.assertIsNone(self.heap.minFibNode)
        self.heap.set_new_min_from_root_list()
        self.assertEqual(self.heap.minFibNode.value, 2)
    ...
    def test_set_new_min_from_root_list_single_node_in_root(self):
        ...
        self.assertIsNone(self.heap.minFibNode)
        self.heap.set_new_min_from_root_list()
        self.assertEqual(self.heap.minFibNode.value, 12)
    ...
    def test_meld_heaps_empty_with_non_empty(self):
        ...
        heap2.insert(6)
        heap2.insert(7)
        self.assertEqual(heap1.minFibNode, None, "Heap should be empty")
        self.assertEqual(heap1.rootList, None, "Heap should be empty")
        self.assertEqual(heap1.totalFibNodes, 0, "Heap should be empty")
        heap1.meld_heaps(heap2)
        self.assertEqual(heap1.minFibNode.value, 5, "After meld, the new min should be 5")
        self.assertEqual(heap1.rootList.value, 5, "The root list should be 5")
        self.assertEqual(heap1.totalFibNodes, 3, "Heap should consist of 3 nodes")
    ...
    def test_meld_heaps_non_empty_with_empty(self):
        ...
        heap1.insert(6)
        heap1.insert(7)
        old_min = heap1.minFibNode.value
        old_root = heap1.rootList.value
        length = heap1.totalFibNodes
        heap1.meld_heaps(heap2)
        self.assertEqual(heap1.minFibNode.value, old_min, "The heap values should not change")
        self.assertEqual(heap1.rootList.value, old_root, "The heap values should not change")
        self.assertEqual(heap1.totalFibNodes, length, "The heap values should not change")
    ...
    def test_meld_heaps_both_non_empty_single_nodes(self):
        ...
        heap2.insert(5)
        heap1.meld_heaps(heap2)
        self.assertEqual(heap1.minFibNode.value, 5, "The heap min should be 5")
        self.assertEqual(heap1.totalFibNodes, 2, "The total nodes should be 2")
    ...
    def test_meld_heaps_both_non_empty(self):
        ...
        heap2.insert(7)
        heap1.meld_heaps(heap2)
        self.assertEqual(heap1.minFibNode.value, 5, "The new min node should be 5")
        self.assertEqual(heap1.totalFibNodes, 6, "The new total nodes should be 6")

    #MELD INTO ROOT TESTING 
    def test_meld_into_rootList_non_empty_root_list(self):
        self.heap.insert(2)
        self.heap.insert(4)
        new_node = FibonacciHeap.FibonacciHeapNode(20, 1)
        self.heap.meld_node_into_root_list(new_node)
        self.assertEqual(self.heap.rootList.right.right.value, 20)
        self.assertEqual(self.heap.rootList.left.value, 20)
        self.assertEqual(self.heap.rootList.right.right.right.value, 2)
        self.assertEqual(self.heap.rootList.right.right.left.value, 4)
        self.assertEqual(self.heap.rootList.value, 2)
    
    def test_meld_into_root_list_empty_root_list(self):
        new_node = FibonacciHeap.FibonacciHeapNode(20, 1)
        self.heap.meld_node_into_root_list(new_node)
        self.assertEqual(self.heap.rootList.value, 20)
    ...
    def test_remove_node_from_root_list_size_above_one(self):
        ...
        self.assertEqual(self.heap.rootList.value, 2)
        self.assertEqual(self.heap.rootList.right.value, 4)
        self.assertEqual(self.heap.rootList.right.right.value, 2)
    
    def test_remove_node_from_root_list_size_exactly_one(self):
        node = self.heap.insert(6)
        self.heap.remove_node_from_root_list(node[0])
        self.assertIsNone(self.heap.rootList)
        self.assertIsNone(self.heap.minFibNode)
    ...
    def test_meld_into_child_list_non_empty_child_list(self):
        ...
        self.assertEqual(self.heap.rootList.child.value, 6)
        self.assertEqual(self.heap.rootList.child.left.value, 20)
        self.assertEqual(self.heap.rootList.child.right.value, 8)
        self.assertEqual(self.heap.rootList.child.right.right.value, 20)
    
    def test_meld_into_child_list_empty_child_list(self):
        parent = self.heap.insert(1)
        child = FibonacciHeap.FibonacciHeapNode(20, 1)
        self.heap.meld_node_into_child_list(child, parent[0])
        self.assertEqual(self.heap.rootList.child.value, 20)
        self.assertEqual(self.heap.rootList.child.right.value, 20)
        self.assertEqual(self.heap.rootList.child.left.value, 20)
    ...
    def test_remove_node_from_child_list_above_one_child(self):
        ...
        self.assertEqual(self.heap.rootList.child.value, 6)
        self.assertEqual(self.heap.rootList.child.left.value, 6)
        self.assertEqual(self.heap.rootList.child.right.value, 6)
    ...
    def test_remove_node_from_child_list_exactly_one_child(self):
        ...
        self.heap.extract_min()
        self.heap.remove_node_from_child_list(child[0])
        self.assertIsNone(self.heap.rootList.child)
    ...
    def test_extract_min_single_root_with_multiple_children(self):
        ...
        self.assertEqual(self.heap.rootList.value, 2)
        self.assertEqual(self.heap.rootList.right.value, 3)
        self.assertEqual(self.heap.rootList.right.right.value, 5)

    def test_extract_min_with_5_len_rootList(self):
        self.heap.insert(10)
        self.heap.insert(5)
        self.heap.insert(1)
        self.heap.insert(3)
        ...
        self.assertEqual(self.heap.rootList.value, 3)
        self.assertEqual(self.heap.rootList.child.value, 15)
        self.assertEqual(self.heap.rootList.child.right.value, 5)
        self.assertEqual(self.heap.rootList.child.right.child.value, 10)
    ...
    def test_consolidate(self):
        ...
        self.assertEqual(self.heap.rootList.value, 1, "Root stays as 1")
        self.assertEqual(self.heap.rootList.child.value, 2, "First child of root")
        self.assertEqual(self.heap.rootList.child.right.value, 3, "Second child of root")
        self.assertEqual(self.heap.rootList.child.right.child.value, 4, "child of second child of root")
    ...
    def test_link_nodes(self):
        ...
        self.assertEqual(self.heap.rootList.value, 2)
        self.assertEqual(self.heap.rootList.right.value, 2)
    ...
    def test_decrease_value_value_lower_than_node_value_and_higher_than_parent(self):
        ...
        self.assertEqual(self.heap.rootList.value, 20)
        self.assertEqual(self.heap.rootList.right.value, 20)
        self.assertEqual(self.heap.rootList.child.value, 25, "Should remain child, but value changed")
    ...
    def test_decrease_value_value_lower_than_node_value_and_lower_than_parent(self):
        ...
        self.assertEqual(self.heap.rootList.value, 20)
        self.assertEqual(self.heap.rootList.right.value, 2, "The node decreased has been cut and added to root list since it violates the heap property")
        self.assertIsNone(self.heap.rootList.child)
    ...
    def test_decrease_value_with_cut_and_cascading_cut(self):
        ...
        #Original root
        self.assertEqual(self.heap.rootList.value, 1)
        self.assertEqual(self.heap.rootList.degree, 3)

        #First Cut 
        self.assertEqual(self.heap.rootList.right.value, -10)
        self.assertEqual(self.heap.rootList.right.degree, 0)

        #Second Cut
        self.assertEqual(self.heap.rootList.right.right.value, -14)
        self.assertEqual(self.heap.rootList.right.right.degree, 0)

        #Third Cut
        self.assertEqual(self.heap.rootList.right.right.right.value, -15)
        self.assertEqual(self.heap.rootList.right.right.right.degree, 1)

        #First cascading cut 
        self.assertEqual(self.heap.rootList.right.right.right.right.value, 13)
        self.assertEqual(self.heap.rootList.right.right.right.right.degree, 0)

        #Second cascading cut 
        self.assertEqual(self.heap.rootList.right.right.right.right.right.value, 9)
        self.assertEqual(self.heap.rootList.right.right.right.right.right.degree, 1)
